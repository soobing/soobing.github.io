...
export default ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <p>
        안녕하세요 박수빈 입니다. <code className="language-text">제가 만든 것이 누군가에게 편리함을 준다</code>는 것에 큰 동기부여를 얻습니다.
      ...
      <h1>Awards</h1>
      <ul>
        <li onClick={() => console.log('hi')}>2019 공개SW 컨트리뷰톤(장려상) / 정보통신산업진흥원 __ 2019.12</li>
